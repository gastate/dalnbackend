...
public class Post {
    ...
    public boolean getIsPostNotApproved() {return isPostNotApproved;}
    public void setIsPostNotApproved(boolean isPostNotApproved) {this.isPostNotApproved = isPostNotApproved;}
